...
class ApiAction {
  ...
  Future<FactCheckResponse> getFactCheckApi({
    ...
    return FactCheckResponse.fromJson(json);
  }
  ...
  Future<NewsResponse> getNewsDataApi({
    ...
    if (sentiment != null) url += "&sentiment=$sentiment";
    ...
    if (full_content != null) url += "&full_content=$full_content";
    ...
    NewsResponse newsResponse = NewsResponse.fromJsonNewsData(json);
